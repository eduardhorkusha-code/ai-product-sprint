...
3. **[research/STATUS.md](research/STATUS.md)** — що покрито (ресерч ~100%, всі плями закриті)
4. **[SETUP.md](SETUP.md)** — підготовка середовища + порядок старту в день X
5. **[GSTACK.md](GSTACK.md)** — операційна система команди (фаза→скіл→хто)
6. **[starter/STARTER.md](starter/STARTER.md)** — готовий код для копіювання в день X
